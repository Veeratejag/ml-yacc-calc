       ...
       of NONE => yyAction31(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx25
              ...
              else yyQ102(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction23(strm, yyNO_MATCH)
                      else yyQ29(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ29(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp = 0wx60
       ...
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5F
              ...
              then yyQ31(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
            else if inp < 0wx65
              then if inp = 0wx60
                  then yyAction26(strm, yyNO_MATCH)
                  else yyQ29(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction22(strm, yyNO_MATCH)
                      else yyQ29(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction22(strm, yyNO_MATCH)
                  else yyQ29(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction21(strm, yyNO_MATCH)
                      else yyQ29(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction21(strm, yyNO_MATCH)
                  else yyQ29(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction25(strm, yyNO_MATCH)
                      else yyQ70(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction25(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp = 0wx60
              ...
              then if inp = 0wx5F
                  then yyQ70(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
       ...
       of NONE => yyAction1(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx20
              ...
              then yyQ92(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp < 0wx30
              then yyAction1(strm, yyNO_MATCH)
            else if inp <= 0wx39
              then yyQ92(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = 0wxB
              ...
              then if inp = 0wxA
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp = 0wxD
              then yyAction2(strm, yyNO_MATCH)
              else yyQ84(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction1(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxB
              ...
              then if inp = 0wxA
                  then yyAction1(strm, yyNO_MATCH)
                  else yyQ84(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp = 0wxD
              then yyAction1(strm, yyNO_MATCH)
              else yyQ84(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction2(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxD
              ...
              then if inp = 0wxA
                  then yyQ94(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
                  else yyQ98(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp = 0wx22
        ...
        | SOME(inp, strm') =>
            if inp = 0wxE
              ...
              then if inp = 0wxA
                  ...
                  then yyQ91(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
                  else yyQ90(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp = 0wx21
              then yyQ84(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp < 0wx21
              then if inp = 0wx20
       ...
       of NONE => yyAction2(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxD
              ...
              then yyQ86(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
              else yyQ84(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction2(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxD
              ...
              then yyQ85(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
              else yyQ84(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction29(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxE
              ...
              then if inp <= 0wx8
                  then yyAction29(strm, yyNO_MATCH)
                  else yyQ100(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
            else if inp = 0wx20
       ...
       of NONE => yyAction0(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxE
              ...
              then if inp <= 0wx8
                  then yyAction0(strm, yyNO_MATCH)
                  else yyQ101(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
            else if inp = 0wx20
...
fun yyQ0 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = 0wxB
              then yyQ0(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp < 0wxB
              then if inp = 0wxA
                  ...
                  else yyQ0(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp = 0wxD
              then if ULexBuffer.eof(!(yystrm))
                  then let
                    val yycolno = ref(yygetcolNo(!(yystrm)))
...
in
  (case (!(yyss))
   of CODELN => yyQ0(!(yystrm), yyNO_MATCH)
