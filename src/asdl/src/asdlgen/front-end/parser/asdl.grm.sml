...
fun Root_PROD_1_ACT (Include, MarkDecl, Include_SPAN : (Lex.pos * Lex.pos), MarkDecl_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.File{includes = Include, decls = MarkDecl})
fun Include_PROD_1_ACT (KW_include, CODE, KW_include_SPAN : (Lex.pos * Lex.pos), CODE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
...
fun Decl_PROD_1_ACT (KW_module, LBRACE, Id, RBRACE, ModuleImport, TypeDecl, KW_module_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), ModuleImport_SPAN : (Lex.pos * Lex.pos), TypeDecl_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.D_Module{name = Id, imports = ModuleImport, decls = TypeDecl})
fun Decl_PROD_2_ACT (KW_module, LBRACE, RBRACE, Id1, Id2, KW_primitive, KW_module_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), Id1_SPAN : (Lex.pos * Lex.pos), Id2_SPAN : (Lex.pos * Lex.pos), KW_primitive_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.D_Primitive{name = Id1, exports = Id2})
fun Decl_PROD_3_ACT (LBRACE, Id, RBRACE, MarkViewEntry, KW_view, LBRACE_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), MarkViewEntry_SPAN : (Lex.pos * Lex.pos), KW_view_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
...
fun ModuleImport_PROD_2_ACT (LPAREN, Import, RPAREN, LPAREN_SPAN : (Lex.pos * Lex.pos), Import_SPAN : (Lex.pos * Lex.pos), RPAREN_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (Import)
fun Import_PROD_1_ACT (KW_import, Id, SR, KW_import_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), SR_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (mark PT.Import_Mark (FULL_SPAN, PT.Import{module = Id, alias=SR}))
fun TypeDecl_PROD_1_ACT (EQ, TypeDef, TyId, EQ_SPAN : (Lex.pos * Lex.pos), TypeDef_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (mark PT.TD_Mark (FULL_SPAN, TypeDef TyId))
fun TypeDef_PROD_1_ACT (QualId, TyCon, QualId_SPAN : (Lex.pos * Lex.pos), TyCon_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
...
fun QualId_PROD_1_ACT (TyId, TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (NONE, TyId)
fun QualId_PROD_2_ACT (DOT, Id, TyId, DOT_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (SOME Id, TyId)
fun Constructors_PROD_1_ACT (Constructor, SR, Constructor_SPAN : (Lex.pos * Lex.pos), SR_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (Constructor :: SR)
...
fun Fields_PROD_1_ACT (SR, Field, SR_SPAN : (Lex.pos * Lex.pos), Field_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (Field :: SR)
fun Field_PROD_1_ACT (QualId, TyCon, Id, QualId_SPAN : (Lex.pos * Lex.pos), TyCon_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (let
...
fun ViewEntry_PROD_1_ACT (ViewEntities, LEQ, ViewProps, ViewEntities_SPAN : (Lex.pos * Lex.pos), LEQ_SPAN : (Lex.pos * Lex.pos), ViewProps_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntry(ViewEntities, ViewProps))
fun ViewEntry_PROD_2_ACT (LBRACE, MarkViewEntityCode, Id, LEQ, RBRACE, LBRACE_SPAN : (Lex.pos * Lex.pos), MarkViewEntityCode_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), LEQ_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntry_Multiple(Id, MarkViewEntityCode))
fun MarkViewEntityCode_PROD_1_ACT (ViewEntity, CODE, ViewEntity_SPAN : (Lex.pos * Lex.pos), CODE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (ViewEntity, CODE)
fun ViewEntities_PROD_1_ACT (MarkViewEntity, MarkViewEntity_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  ([MarkViewEntity])
fun ViewEntities_PROD_2_ACT (LBRACE, RBRACE, MarkViewEntity, LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), MarkViewEntity_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (MarkViewEntity)
...
fun ViewEntity_PROD_1_ACT (FILE, FILE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntity_File)
fun ViewEntity_PROD_2_ACT (KW_module, Id, KW_module_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntity_Module Id)
fun ViewEntity_PROD_3_ACT (DOT, Id, TyId, DOT_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntity_Type(Id, TyId))
fun ViewEntity_PROD_4_ACT (Id, DOT1, DOT2, SEQUENCE, TyId, Id_SPAN : (Lex.pos * Lex.pos), DOT1_SPAN : (Lex.pos * Lex.pos), DOT2_SPAN : (Lex.pos * Lex.pos), SEQUENCE_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntity_AllCons(Id, TyId))
fun ViewEntity_PROD_5_ACT (ConId, Id, DOT1, DOT2, TyId, ConId_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), DOT1_SPAN : (Lex.pos * Lex.pos), DOT2_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntity_Cons(Id, TyId, ConId))
fun ViewProps_PROD_1_ACT (ViewProp, ViewProp_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  ([ViewProp])
fun ViewProps_PROD_2_ACT (LBRACE, ViewProp, RBRACE, LBRACE_SPAN : (Lex.pos * Lex.pos), ViewProp_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (ViewProp)
...
fun ViewEntity_NT (strm) = let
      ...
      fun ViewEntity_PROD_2 (strm) = let
            ...
            in
              (UserCode.ViewEntity_PROD_2_ACT (KW_module_RES, Id_RES, KW_module_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun ViewEntity_PROD_3 (strm) = let
            ...
            in
              (UserCode.ViewEntity_PROD_3_ACT (DOT_RES, Id_RES, TyId_RES, DOT_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun ViewEntity_PROD_4 (strm) = let
            ...
            in
              (UserCode.ViewEntity_PROD_4_ACT (Id_RES, DOT1_RES, DOT2_RES, SEQUENCE_RES, TyId_RES, Id_SPAN : (Lex.pos * Lex.pos), DOT1_SPAN : (Lex.pos * Lex.pos), DOT2_SPAN : (Lex.pos * Lex.pos), SEQUENCE_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun ViewEntity_PROD_5 (strm) = let
            ...
            in
              (UserCode.ViewEntity_PROD_5_ACT (ConId_RES, Id_RES, DOT1_RES, DOT2_RES, TyId_RES, ConId_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), DOT1_SPAN : (Lex.pos * Lex.pos), DOT2_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun MarkViewEntityCode_NT (strm) = let
      ...
      in
        (UserCode.MarkViewEntityCode_PROD_1_ACT (ViewEntity_RES, CODE_RES, ViewEntity_SPAN : (Lex.pos * Lex.pos), CODE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
          FULL_SPAN, strm')
      end
...
fun ViewProps_NT (strm) = let
      ...
      fun ViewProps_PROD_2 (strm) = let
            ...
            in
              (UserCode.ViewProps_PROD_2_ACT (LBRACE_RES, ViewProp_RES, RBRACE_RES, LBRACE_SPAN : (Lex.pos * Lex.pos), ViewProp_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun ViewEntities_NT (strm) = let
      ...
      fun ViewEntities_PROD_2 (strm) = let
            ...
            val FULL_SPAN = (#1(LBRACE_SPAN), #2(RBRACE_SPAN))
            in
              (UserCode.ViewEntities_PROD_2_ACT (LBRACE_RES, RBRACE_RES, MarkViewEntity_RES, LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), MarkViewEntity_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun ViewEntry_NT (strm) = let
      fun ViewEntry_PROD_1 (strm) = let
            ...
            in
              (UserCode.ViewEntry_PROD_1_ACT (ViewEntities_RES, LEQ_RES, ViewProps_RES, ViewEntities_SPAN : (Lex.pos * Lex.pos), LEQ_SPAN : (Lex.pos * Lex.pos), ViewProps_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun ViewEntry_PROD_2 (strm) = let
            ...
            in
              (UserCode.ViewEntry_PROD_2_ACT (LBRACE_RES, MarkViewEntityCode_RES, Id_RES, LEQ_RES, RBRACE_RES, LBRACE_SPAN : (Lex.pos * Lex.pos), MarkViewEntityCode_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), LEQ_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun QualId_NT (strm) = let
      ...
      fun QualId_PROD_2 (strm) = let
            ...
            val FULL_SPAN = (#1(Id_SPAN), #2(TyId_SPAN))
            in
              (UserCode.QualId_PROD_2_ACT (DOT_RES, Id_RES, TyId_RES, DOT_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun Field_NT (strm) = let
      ...
      in
        (UserCode.Field_PROD_1_ACT (QualId_RES, TyCon_RES, Id_RES, QualId_SPAN : (Lex.pos * Lex.pos), TyCon_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
          FULL_SPAN, strm')
      end
...
fun Constructors_NT (strm) = let
      ...
      in
        (UserCode.Constructors_PROD_1_ACT (Constructor_RES, SR_RES, Constructor_SPAN : (Lex.pos * Lex.pos), SR_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
          FULL_SPAN, strm')
      end
fun TypeDef_NT (strm) = let
      fun TypeDef_PROD_1 (strm) = let
            ...
            in
              (UserCode.TypeDef_PROD_1_ACT (QualId_RES, TyCon_RES, QualId_SPAN : (Lex.pos * Lex.pos), TyCon_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
...
fun TypeDecl_NT (strm) = let
      ...
      in
        (UserCode.TypeDecl_PROD_1_ACT (EQ_RES, TypeDef_RES, TyId_RES, EQ_SPAN : (Lex.pos * Lex.pos), TypeDef_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
          FULL_SPAN, strm')
      end
fun Import_NT (strm) = let
      ...
      in
        (UserCode.Import_PROD_1_ACT (KW_import_RES, Id_RES, SR_RES, KW_import_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), SR_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
          FULL_SPAN, strm')
      end
...
fun Decl_NT (strm) = let
      fun Decl_PROD_1 (strm) = let
            ...
            in
              (UserCode.Decl_PROD_1_ACT (KW_module_RES, LBRACE_RES, Id_RES, RBRACE_RES, ModuleImport_RES, TypeDecl_RES, KW_module_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), ModuleImport_SPAN : (Lex.pos * Lex.pos), TypeDecl_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun Decl_PROD_2 (strm) = let
            ...
            in
              (UserCode.Decl_PROD_2_ACT (KW_module_RES, LBRACE_RES, RBRACE_RES, Id1_RES, Id2_RES, KW_primitive_RES, KW_module_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), Id1_SPAN : (Lex.pos * Lex.pos), Id2_SPAN : (Lex.pos * Lex.pos), KW_primitive_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun Decl_PROD_3 (strm) = let
            ...
            in
              (UserCode.Decl_PROD_3_ACT (LBRACE_RES, Id_RES, RBRACE_RES, MarkViewEntry_RES, KW_view_RES, LBRACE_SPAN : (Lex.pos * Lex.pos), Id_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), MarkViewEntry_SPAN : (Lex.pos * Lex.pos), KW_view_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun Include_NT (strm) = let
      ...
      in
        (UserCode.Include_PROD_1_ACT (KW_include_RES, CODE_RES, KW_include_SPAN : (Lex.pos * Lex.pos), CODE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
          FULL_SPAN, strm')
      end
fun Root_NT (strm) = let
      ...
      in
        (UserCode.Root_PROD_1_ACT (Include_RES, MarkDecl_RES, Include_SPAN : (Lex.pos * Lex.pos), MarkDecl_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
          FULL_SPAN, strm')
      end
in
  (Root_NT)
